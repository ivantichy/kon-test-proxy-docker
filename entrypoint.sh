...
if [ \! -f  /etc/letsencrypt/live/bitbucket.ivantichy.cz/privkey.pem ]; then
  certbot certonly --standalone --break-my-certs -d bitbucket.ivantichy.cz --renew-by-default --email ivan.tichy@gmail.com --agree-tos --standalone-supported-challenges tls-sni-01
